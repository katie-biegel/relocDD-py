...
def readeventsel(log,fileout,selev):
    """
...
def readphase(log,phasefile,datfol,minwght,minobs_pair,nsta,fileout=0,
              MAXEV=10000,fevsel='datfiles/events.select'):
    """ 
    ...
    """
    selev = readeventsel(log,fileout,fevsel)
    if selev:
        ncusp = selev[0]
        icusp = selev[1]
